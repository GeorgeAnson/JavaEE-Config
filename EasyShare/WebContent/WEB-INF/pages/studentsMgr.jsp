...
<body>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                ...
                                                <c:forEach items="${students}" var="student">
                                                	...
                                                	<tr class="">
                                                        ...
                                                        <c:choose>
                                                        	<c:when test="${empty student.studentNum}"><td>未填写</td></c:when>
                                                        	<c:otherwise><td>${student.studentNum}</td></c:otherwise>
                                                        </c:choose>
                                                        <c:choose>
                                                        	<c:when test="${not empty student.commonUserInfo.realName}"><td>${student.commonUserInfo.realName}</td></c:when>
                                                        	<c:otherwise><td>${student.commonUserInfo.loginName}</td></c:otherwise>
                                                        </c:choose>
                                                        <c:choose>
                                                        	<c:when test="${empty student.grade}"><td>未填写</td></c:when>
                                                        	<c:otherwise><td>${student.grade}</td></c:otherwise>
                                                        </c:choose>
                                                        <c:choose>
                                                        	<c:when test="${student.commonUserInfo.gender==false}"><td>男</td></c:when>
                                                        	<c:otherwise><td>女</td></c:otherwise>
                                                        </c:choose>
                                                         <c:choose>
                                                        	<c:when test="${empty student.commonUserInfo.phone}"><td>未填写</td></c:when>
                                                        	<c:otherwise><td>${student.commonUserInfo.phone}</td></c:otherwise>
                                                        </c:choose>
                                                        <c:choose>
                                                        	<c:when test="${student.commonUserInfo.status==1}"><td>正常</td></c:when>
                                                        	<c:otherwise><td>冻结</td></c:otherwise>
                                                        </c:choose>
                                                       <c:if test="${student.commonUserInfo.userType==2 and student.commonUserInfo.adminType==-1}">
				        									<td>学生-普通用户</td>
				        								</c:if>
				        								<c:if test="${student.commonUserInfo.userType==2 and student.commonUserInfo.adminType==0}">
				        									<td>学生-系统管理</td>
				        								</c:if>
				        								<c:if test="${student.commonUserInfo.userType==2 and student.commonUserInfo.adminType==1}">
				        									<td>学生-人员管理</td>
				        								</c:if>
				        								<c:if test="${student.commonUserInfo.userType==2 and student.commonUserInfo.adminType==2}">
				        									<td>学生-书籍管理</td>
				        								</c:if>
				        								<c:if test="${student.commonUserInfo.userType==2 and student.commonUserInfo.adminType==3}">
				        									<td>学生-设备管理</td>
				        								</c:if>
				        								<c:if test="${student.commonUserInfo.userType==2 and student.commonUserInfo.adminType==4}">
				        									<td>学生-杂物管理</td>
				        								</c:if>
				        								<c:if test="${student.commonUserInfo.userType==2 and student.commonUserInfo.adminType==5}">
				        									<td>学生-项目管理</td>
				        								</c:if>
				        								<c:if test="${student.commonUserInfo.userType==2 and student.commonUserInfo.adminType==6}">
				        									<td>学生-财务管理</td>
				        								</c:if>
				        								<c:choose>
				        									<c:when test="${student.commonUserInfo.isGraduate==true}"><td>是</td></c:when>
				        									<c:otherwise>
				        										<c:choose>
				        											<c:when test="${student.commonUserInfo.isGraduate==false}"><td>否</td></c:when>
				        											<c:otherwise><td>未知</td></c:otherwise>
				        										</c:choose>
															</c:otherwise>
				        								</c:choose>
                                                        <td><a href="${pageContext.request.contextPath}/members.html?type=delete&id=${student.studentID}&userType=2" class="delOp">删除</a></td>
                                                    </tr>
                                                    </c:if>
                                                </c:forEach>
                                                </tbody>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane fade active in" id="addMember">
                                                        <div>
                                                        <form action="${pageContext.request.contextPath}/members.html?type=add&userType=2" method="post">
                                                            <div class="sub-title">学生学号</div>
                                                            <div>
                                                                <input name="newStudentNum" type="text" class="form-control inputSty" placeholder="成员学号">
                                                            </div>
                                                            <div class="sub-title">学生姓名</div>
                                                            <div>
                                                                <input name="newRealName" type="text" class="form-control inputSty" placeholder="学生姓名">
                                                            </div>
                                                            ...
                                                            <div class="sub-title">学生性别</div>
                                                            <div>
                                                                  <div class="radio3 radio-check radio-success radio-inline">
                                                                    <input type="radio" id="sex1" name="sex" value="${false}" checked="cheked">
                                                                    <label for="sex1">
                                                                      	男
                                                                    </label>
                                                                  </div>
                                                                  <div class="radio3 radio-check radio-success radio-inline">
                                                                    <input type="radio" id="sex2" name="sex" value="${true}">
                                                                    <label for="sex2">
                                                                      	女
                                                                    </label>
                                                                  </div>
                                                            ...
                                                            <div>
                                                                <div>
                                                                      <div class="radio3 radio-check radio-success radio-inline">
                                                                        <input type="radio" id="graduated1" name="graduated" value="${true}" checked="cheked">
                                                                        <label for="graduated1">
                                                                          	是
                                                                        </label>
                                                                      </div>
                                                                      <div class="radio3 radio-check radio-success radio-inline">
                                                                        <input type="radio" id="graduated2" name="graduated" value="${false}">
                                                    ...
                                                    <div class="tab-pane fade" id="editMember">
                                                        ...
                                                        <div id="updateFream">
                                                            <div>
                                                            	<form action="${pageContext.request.contextPath}/members.html?type=update&userType=2" method="post">
                                                                <div class="sub-title">学生编号</div>
                                                                <div>
                                                                    <input id="memberId" name="userID" type="text" class="form-control inputSty" placeholder="学生编号" readonly="true">
                                                                </div>
                                                                <div class="sub-title">学生学号</div>
                                                                <div>
                                                                    <input id="memberNum" name="studentNum" type="text" class="form-control inputSty" placeholder="学生学号">
                                                                </div>
                                                                <div class="sub-title">学生姓名</div>
                                                                <div>
                                                                    <input id="memberName" name="memberName" type="text" class="form-control inputSty" placeholder="学生姓名">
                                                                </div>
                                                                <div class="sub-title">所处班级</div>
                                                                <div>
                                                                    <input id="memberClass" name="studentClass" type="text" class="form-control inputSty" placeholder="所处班级">
                                                                </div>
                                                                <div class="sub-title">学生性别</div>
                                                                <div>
                                                                      <div class="radio3 radio-check radio-success radio-inline">
                                                                        <input type="radio" id="newSex1" name="newSex" value="${false}" checked="cheked">
                                                                        <label for="newSex1">
                                                                          	男
                                                                        </label>
                                                                      </div>
                                                                      <div class="radio3 radio-check radio-success radio-inline">
                                                                        <input type="radio" id="newSex2" name="newSex" value="${true}">
                                                                        <label for="newSex2">
                                                                          	女
                                                                        </label>
                                                                      </div>
                                                                ...
                                                                <div>
                                                                    <div>
                                                                          <div class="radio3 radio-check radio-success radio-inline">
                                                                            <input type="radio" id="newGraduated1" name="isGraduated" value="${true}" checked="">
                                                                            <label for="newGraduated1">
                                                                              	是
                                                                            </label>
                                                                          </div>
                                                                          <div class="radio3 radio-check radio-success radio-inline">
                                                                            <input type="radio" id="newGraduated2" name="isGraduated" value="${false}">
   ...
   <script type="text/javascript" src="js/labMenStudCus.js"></script>
