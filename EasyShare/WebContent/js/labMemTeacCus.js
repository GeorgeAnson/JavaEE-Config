...
function updateFrameChk(){
    ...
    if(tabler.rows.length != 2){
        ...
        memberName.value = tabler.rows[1].cells[1].innerText;
        memberName.click();

        var memberPro = document.getElementById("memberPro");
        memberPro.value = tabler.rows[1].cells[3].innerText;
        memberPro.click();
//memberContact
        var memberContact = document.getElementById("memberContact");
        memberContact.value = tabler.rows[1].cells[4].innerText;
        memberContact.click();
